export const STRINGS = {
  ...
  legal: `# Legal & Privacy Statement  

[[PRIVACY_MANAGER]]

We strongly support the right to privacy. The Privacy Policy below explains all details on the anonymous user data we would like to process to learn from your usage of this application. Manage your consent to anonymous analytics on our site here:  
...
Phone: 0049 228 429-0 E-Mail: [info@dw.com](mailto:info@dw.com)  
...
-   **Google Street View** – We use the Google Maps Platform to display a Google Street View of a location in the SPOT interface. Google Maps Platform does not process or record any personal data from using the SPOT application.  
-   **MongoDB** – When opening the Google Street View we use MongoDB to store and load sessions for sharing via ‘actions - share session’. MongoDB does not process or record any personal data from using the SPOT application.  
...
-   **YouTube** – We use YouTube to distribute our SPOT tutorial videos. To watch the videos, you have to agree to the YouTube privacy statement.  
...
If you feel that we have missed something, or you need clarification of something specific please feel free to reach out to <hey@findthatspot.io>.`,
};
